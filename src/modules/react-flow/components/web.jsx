...
import { Info, X, ChevronDown, ChevronRight, Globe } from "lucide-react";
                ...
                <div className="p-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                            <div className="w-6 h-6 bg-teal-500 rounded-lg flex items-center justify-center shadow-sm">
                                <Globe size={12} className="text-white" />
                            </div>
                            <div className={`w-2 h-2 rounded-full ${getStatusColor()} shadow-sm`}></div>
                        </div>

                        {/* Web Server ID and Custodian */}
                        ...
                        <button
                            ...
                            className="w-6 h-6 text-gray-400 dark:text-gray-500 hover:text-teal-500 dark:hover:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/30 rounded-lg transition-all duration-200 flex items-center justify-center flex-shrink-0"
                            title="View Details"
                        >
                            <Info size={14} />
                        </button>
